...
ActiveRecord::Schema[7.2].define(version: 2025_11_06_202738) do
  ...
  create_table "play_events", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "potential_increase_of_satisfaction", default: 0.0
    t.float "potential_decrease_of_satisfaction", default: 0.0
